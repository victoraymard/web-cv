...
var bar3 = new ProgressBar.Line(progress_bar3, {
	strokeWidth: 4,
	easing: 'easeInOut',
	duration: 1400,
	color: '#FFEA82',
...
var bar4 = new ProgressBar.Line(progress_bar4, {
	strokeWidth: 4,
	easing: 'easeInOut',
	duration: 1400,
	color: '#FFEA82',
...
bar2.animate(0.2);  // Number from 0.0 to 1.0
bar3.animate(0.2);  // Number from 0.0 to 1.0
bar4.animate(0.2);  // Number from 0.0 to 1.0
